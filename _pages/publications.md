...
{% assign projects_by_year = site.publications | group_by: "year" | sort: "name" | reverse %}
    ...
    <div class="project-entry">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <!-- Button-style links -->
          {% if project.pdf or project.arxiv or project.github or project.demo or project.website or project.abstract %}
